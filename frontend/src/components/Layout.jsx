...
//   Divider, useTheme, useMediaQuery, Tooltip,
// } from '@mui/material'
...
//   { label: 'My Tasks', path: '/tasks', icon: <CheckBoxIcon /> },
// ]
...
//           boxShadow: '0 0 16px rgba(41,121,255,0.4)',
//         }}>
...
//                 sx={{
//                   borderRadius: 2,
//                   bgcolor: active ? 'rgba(41,121,255,0.15)' : 'transparent',
...
//                 <ListItemText primary={label} primaryTypographyProps={{ fontSize: '0.9rem', fontWeight: active ? 600 : 400 }} />
//               </ListItemButton>
//             </ListItem>
//           )
//         })}
...
//                     bgcolor: 'rgba(255,255,255,0.04)', borderRadius: 2, p: 1.2 }}>
//           <Avatar sx={{ width: 34, height: 34, bgcolor: 'primary.dark', fontSize: '0.85rem' }}>
//             {(user?.first_name?.[0] || user?.username?.[0] || 'U').toUpperCase()}
//           </Avatar>
//           <Box sx={{ minWidth: 0 }}>
//             <Typography noWrap variant="body2" fontWeight={600} color="text.primary">
...
//           '&:hover': { bgcolor: 'rgba(244,67,54,0.1)', color: 'error.main' },
//         }}>
...
//               <MenuIcon />
//             </IconButton>
//             <BoltIcon sx={{ color: 'primary.main', mr: 0.8 }} />
//             <Typography variant="h6" color="text.primary">TaskFlow</Typography>
//           </Toolbar>
//         </AppBar>
//       )}
...
//             '& .MuiDrawer-paper': { width: DRAWER_WIDTH, boxSizing: 'border-box', bgcolor: 'background.paper', borderRight: '1px solid rgba(255,255,255,0.07)' },
//           }}
//         >
//           {drawerContent}
//         </Drawer>
  ...
  const drawerContent = (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'background.paper' }}>
      ...
      <Box sx={{ px: 2.5, py: 2.5, display: 'flex', alignItems: 'center', gap: 1.5 }}>
        ...
        <Typography fontWeight={700} fontSize="1rem" color="text.primary" letterSpacing="-0.3px">
          TaskFlow
        </Typography>
      </Box>
      ...
      {/* Nav Items */}
      <List sx={{ px: 1.5, pt: 2, flexGrow: 1, gap: 0.5, display: 'flex', flexDirection: 'column' }}>
        {navItems.map(({ label, path, icon }) => {
          const active = location.pathname === path
          return (
            <ListItem key={path} disablePadding>
              <ListItemButton
                ...
                sx={{
                  ...
                  color: active ? 'primary.light' : 'text.secondary',
                  '&:hover': {
                    bgcolor: active ? 'rgba(41,121,255,0.15)' : 'rgba(255,255,255,0.04)',
                    color: 'text.primary',
                  },
        ...
        <Box sx={{
          ...
          <Box sx={{ minWidth: 0, flex: 1 }}>
            ...
            <Typography
              ...
              noWrap sx={{ display: 'block', fontSize: '0.72rem' }}
            >
              {user?.email || user?.username}
            </Typography>
          </Box>
